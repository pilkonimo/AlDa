...
def create_plots_alt(N_max=300):
    ...
    Make sure to have a subfolder figures.
    """
    ...
    y_lim_top = [5*10**-5, 2*10**-4, 2*10**-4]
...
for algorithm in [insertionSort, mergeSort, quickSort]:
    print(algorithm.__name__ + ' suffices criteria for sorting algorithm: '+str(test_sort(algorithm)))
